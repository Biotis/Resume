...
PySpark를 사용하여 RDD 및 DataFrame 기반으로 모바일 앱 사용 데이터, 정신 건강 설문 응답 데이터, 수면 데이터를 통합하고 전처리한 데이터를 이용해 정신 건강 점수(PHQ-9, GAD-7, Stress)와 앱 사용 패턴 간의 관계를 분석
...
**C, Python, Git, SQL, Linux, HTML, CSS<br>[백준 온라인 저지](https://www.acmicpc.net/user/rhjung2001)**
